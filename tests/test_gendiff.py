...
@pytest.mark.parametrize('file1, file2, expected', [
    ...
    ('tests/fixtures/file1_tree.json', 'tests/fixtures/file2_tree.json', 'tests/fixtures/expected.txt'),
    ('tests/fixtures/file1_tree.yaml', 'tests/fixtures/file2_tree.yaml', 'tests/fixtures/expected.txt')
    ]
)
